...
% L20-PENDING: Trained-Bridge Comparator (Finding 7)
% This section will be appended after WS1 completes and gate_L20*.json is available.
% Placeholder for trained-bridge comparator: lift curves across trained-CittaStore write vs analytic write.
% Trigger: merge WS1 results and read gates/gate_L20*.json; invoke python3 scripts/tools/make_figures.py;
% insert subsection "Finding 7: ..." before end of results.tex.
